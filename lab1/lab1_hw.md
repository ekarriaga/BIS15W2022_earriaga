...
R is a an open source, scripting language, and RStudio is GUI use to interact with R. Github is used for progammers to access and relay codes to the public. 
