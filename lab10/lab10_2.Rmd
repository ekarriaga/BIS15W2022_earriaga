...
homerange %>% 
  ...
  labs(title = "Observations by Taxon in Homerange Data",
       x = "Taxonomic Group",
       fill= "Trophic Guild") # 60 gives the angle of the x axis titles 
```
...
homerange %>% 
  ...
  geom_boxplot() #using color will only color the outline of the boxplots #fill works better than group since we are given a key #but using together can show different categorical data 
```
