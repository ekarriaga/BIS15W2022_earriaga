...
Yes, I think this allows us to have variable in different measurement. Wwe can put titles in the data frame, where as the data matrix puts quantitative or characteristics in the matrix. 
```{r}
